...
module.exports = {
  SESSION_ID: 'QUEENELISA;;;==QQxQmepVWaKpkYFFVbHNTU2tGRRpEVyg1aINmd3EXMQ1WNLp2MxcHeNZEUjI0bEdXUjRGdpwd=64902598322',
  ALIVE_REACT: '👋',
...
Qᴜᴇᴇɴ ᴇʟɪꜱᴀ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ`,
  ...
  OWNER_NAME: 'DEVILOUS',
  OWNER_NUMBER: '22389520946',
  SUDO: '22389520946',
  WORK_TYPE: 'public',
  WORK_MODE: 'group',
  TIME_ZONE: 'Asia/Colombo',
  CAPTION: '© ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ Qᴜᴇᴇɴ ᴇʟɪꜱᴀ ᴍᴅ',
  STICKER_AUTHOR: 'SYMPA',
  STICKER_PACK: 'DEVILOUS',
  REMOVE_BG_APIKEY: '',
  MAXIMUM_FILESIZE: 90,
  OWNER_R_EMOJI: '👽',
  ALIVE_AS_GIF: true,
